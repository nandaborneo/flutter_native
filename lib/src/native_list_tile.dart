...
class NativeListTile extends StatelessWidget {
  ...
  static Iterable<Widget> divideTiles({
    ...
    final Decoration decoration = BoxDecoration(
      border: Border(
        bottom: material.Divider.createBorderSide(context, color: color),
      ),
    );
  ...
  Color _iconColor(material.ThemeData theme, material.ListTileTheme tileTheme) {
    ...
    switch (theme.brightness) {
      case Brightness.light:
        return selected ? theme.primaryColor : material.Colors.black45;
  ...
  bool _isDenseLayout(material.ListTileTheme tileTheme) {
  ...
  Widget build(BuildContext context) {
    material.ThemeData theme;
    material.ListTileTheme tileTheme;
    if (platformWidget == PlatformWidget.material) {
      assert(material.debugCheckHasMaterial(context));
      theme = material.Theme.of(context);
      tileTheme = material.ListTileTheme.of(context);
    } else {
      theme = material.ThemeData(
        cupertinoOverrideTheme: CupertinoTheme.of(context),
      );
      tileTheme = material.ListTileTheme();
    }
    ...
    final child = Semantics(
      ...
      child: SafeArea(
        ...
        child: _ListTile(
          ...
          titleBaselineType: titleStyle.textBaseline ?? TextBaseline.alphabetic,
